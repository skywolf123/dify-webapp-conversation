...
import type { ChatItem, Feedbacktype, VisionSettings } from '@/types/app'
...
interface MessageHandlingProps {
  APP_ID: string
  promptConfig: any
  visionConfig: VisionSettings | undefined
...
const MessageHandling: React.FC<MessageHandlingProps> = ({
  APP_ID,
  promptConfig,
  visionConfig,
  currConversationId,
