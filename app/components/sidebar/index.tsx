          ...
          <Button
            ...
            className={classNames(
              list.length >= MAX_CONVERSATION_LENTH
                ...
                : 'text-primary-600',
              'group block w-full flex-shrink-0 !justify-start !h-9 items-center text-sm',)}>
            <PencilSquareIcon className="mr-2 h-4 w-4" /> {t('app.chat.newChat')}【{list.length} / {MAX_CONVERSATION_LENTH}】
          </Button>
        </div>
